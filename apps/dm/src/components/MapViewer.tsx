            ...
            return (
              ...
              >
                ...
                {(isSelected || isEditing) && (
                  <div
                    className="absolute top-6 left-1/2 -translate-x-1/2 bg-[var(--bg-primary)]/92 [backdrop-filter:blur(2px)] border border-[var(--bg-tertiary)] rounded p-2 shadow-lg min-w-[140px]"
